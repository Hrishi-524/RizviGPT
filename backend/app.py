...
#     description="AI-powered college assistant with RAG",
#     version="1.0.0"
# )
...
#     Upload PDFs to ./data folder before calling this endpoint
#     """
#     try:
...
#         else:
#             raise HTTPException(status_code=404, detail="Session not found or database not enabled")
#     except Exception as e:
#         raise HTTPException(status_code=500, detail=str(e))
